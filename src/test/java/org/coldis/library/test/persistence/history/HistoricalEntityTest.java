...
// import
// org.coldis.library.test.persistence.history.historical.repository.TestHistoricalEntityHistoryRepository;
...
// */
// @Autowired
// private TestHistoricalEntityHistoryRepository
// testHistoricalEntityHistoryRepository;
//
// /**
...
// final TestHistoricalEntity testHistoricalEntity1 =
// this.testHistoricalEntityService.save(new TestHistoricalEntity("1"));
// // Makes sure the new entity state is also replicated as historical data.
// Assertions.assertTrue(TestHelper.waitUntilValid(() ->
// this.testHistoricalEntityHistoryRepository.findAll(),
// (entityHistoryList) ->
// IterableUtils.toList(entityHistoryList).stream().anyMatch((entity) -> {
// // Converts the state into an entity.
// final TestHistoricalEntity testHistoricalEntity =
// ObjectMapperHelper.convert(this.objectMapper, entity.getState(),
...
// final TestHistoricalEntity testHistoricalEntity2 =
// this.testHistoricalEntityService.save(testHistoricalEntity1);
